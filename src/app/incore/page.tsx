...
export default function InCorePage() {
  return (
    <main className="min-h-[80vh] flex-col items-center justify-center bg-[#001631] py-24 md:py-36">
      <Container size="2xl">
        <div className="relative text-center">
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="relative h-[70vw] max-h-[700px] w-[70vw] max-w-[700px]">
              {/* 00DFDF at right bottom corner */}
              <div className="absolute right-0 bottom-0 h-[38%] w-[38%] rounded-full bg-[#00DFDF] blur-[90px]"></div>

              {/* 0A7CFF at right corner (top-right) */}
              <div className="absolute top-0 right-0 h-[35%] w-[35%] rounded-full bg-[#0A7CFF] blur-[90px]"></div>

              {/* 7733FF at top center */}
              <div className="absolute top-0 left-1/2 h-[40%] w-[40%] -translate-x-1/2 rounded-full bg-[#7733FF] blur-[90px]"></div>

              {/* 7733FF at bottom center */}
              <div className="absolute bottom-0 left-1/2 h-[35%] w-[35%] -translate-x-1/2 rounded-full bg-[#7733FF] blur-[90px]"></div>

              {/* FF469D at left top corner */}
              <div className="absolute top-0 left-0 h-[32%] w-[32%] rounded-full bg-[#FF469D] blur-[90px]"></div>

              {/* FF7847 at left (center-left) */}
              <div className="absolute top-1/2 left-0 h-[36%] w-[36%] -translate-y-1/2 rounded-full bg-[#FF7847] blur-[90px]"></div>
            </div>
          </div>
          ...
          <div className="relative z-10">
            <h1
              className={cn(
                "font-sans text-3xl font-semibold text-white md:text-5xl",
              )}
            >
        ...
        <div
          className="pointer-events-none absolute -bottom-20 left-0 z-[5] select-none"
          aria-hidden="true"
        >
          <svg
            width="155"
