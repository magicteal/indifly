...
export default function InCorePage() {
  return (
    <main className="min-h-[80vh] bg-[#001631] flex-col items-center justify-center py-24 md:py-36 ">
      <Container size="2xl">
        <div className="relative text-center">
          ...
          <div
            ...
            aria-hidden="true"
          >
            <div className="relative w-[70vw] max-w-[700px] h-[70vw] max-h-[700px]">
              {/* 00DFDF at right bottom corner */}
              <div className="absolute bottom-0 right-0 w-[38%] h-[38%] bg-[#00DFDF] rounded-full blur-[90px]"></div>

              {/* 0A7CFF at right corner (top-right) */}
              <div className="absolute top-0 right-0 w-[35%] h-[35%] bg-[#0A7CFF] rounded-full blur-[90px] "></div>

              {/* 7733FF at top center */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[40%] h-[40%] bg-[#7733FF] rounded-full blur-[90px] "></div>

              {/* 7733FF at bottom center */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[35%] h-[35%] bg-[#7733FF] rounded-full blur-[90px] "></div>

              {/* FF469D at left top corner */}
              <div className="absolute top-0 left-0 w-[32%] h-[32%] bg-[#FF469D] rounded-full blur-[90px] "></div>

              {/* FF7847 at left (center-left) */}
              <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[36%] h-[36%] bg-[#FF7847] rounded-full blur-[90px] "></div>
            </div>
          </div>
        ...
        <div className="absolute -bottom-20 left-0  z-[5] pointer-events-none select-none" aria-hidden="true">
