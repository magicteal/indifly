    ...
    <section className="relative w-full overflow-hidden pt-16 pb-20">
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="flex flex-col items-stretch gap-6 md:flex-row md:gap-6">
          {/* Left: big card */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#F7ECE6] to-[#EFDCD4] shadow-lg md:h-[339px] md:w-[356px] md:overflow-visible">
          ...
          <div className="flex flex-1 flex-col gap-6 md:gap-4">
            ...
            <div className="flex items-stretch gap-6 md:gap-4">
              <div className="flex flex-1 items-center justify-center rounded-2xl bg-[#F56522] p-6 shadow-lg md:h-[165px]">
                <Link href="/incore">
                  <Image
                    src="/inCore.svg"
                    alt="inCORE"
              ...
              <div className="flex flex-1 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1677FF] to-[#4AA3FF] p-6 shadow-lg md:h-[165px]">
                <Image
            ...
            <div className="flex items-stretch gap-6 md:gap-4">
              <div className="flex h-[100px] flex-[1.5] items-center justify-center rounded-2xl bg-gradient-to-r from-white/70 to-sky-100/70 p-6 text-center shadow-lg backdrop-blur-md md:h-[158px] md:flex-[0.65]">
                <Link
              ...
              <div className="flex h-[100px] flex-1 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FBF6F4] to-[#F6EFE9] p-6 text-center shadow-lg md:h-[158px] md:flex-[0.35]">
                <Link
                  href="#contact"
