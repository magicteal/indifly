    ...
    <section className="relative w-full overflow-hidden pt-16 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 md:grid-cols-[356px_minmax(330px,1fr)] md:grid-rows-[165px_158px] md:gap-x-6 md:gap-y-4">
          ...
          <div className="reveal-left relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#F7ECE6] to-[#EFDCD4] shadow-lg md:row-span-2 md:h-[339px] md:w-[356px] md:overflow-visible">
            ...
            <div className="flex h-full flex-col justify-between p-8">
              ...
              <div>
                ...
                <Link
                  href="#our-portfolio"
                  className="reveal-section mt-6 inline-block rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-blue-700"
                >
                  Know More <span aria-hidden>→</span>
                </Link>
              </div>
            </div>
            <VenturesGridMan className="reveal-image pointer-events-none absolute -right-5 -bottom-2 z-20 w-40 sm:w-48 md:-right-20 md:-bottom-2.5 md:w-56 lg:w-60 xl:-right-30 xl:-bottom-3 xl:w-72" />
          </div>
          ...
          <div className="flex h-full flex-col gap-6 md:col-start-2 md:row-span-2 md:gap-4">
            ...
            >
              ...
              <div className="reveal-right flex h-full flex-1 items-center justify-center rounded-2xl bg-gradient-to-br from-[#1677FF] to-[#4AA3FF] p-6 shadow-lg md:h-[165px]">
                <h3 className="text-lg font-bold tracking-tight text-white md:text-3xl">
                  <Image
            ...
            {/* Bottom row */}
            <div className="flex gap-6" data-reveal-stagger>
              <div className="reveal-right flex h-[100px] flex-[1.5] items-center justify-center rounded-2xl bg-gradient-to-r from-white/70 to-sky-100/70 p-6 text-center shadow-lg backdrop-blur-md md:h-[158px] md:flex-[0.65]">
                <Link
              ...
              <div className="reveal-right flex h-[100px] flex-1 items-center justify-center rounded-2xl bg-gradient-to-br from-[#FBF6F4] to-[#F6EFE9] p-6 text-center shadow-lg md:h-[158px] md:flex-[0.35]">
                <Link
                  href="#contact"
