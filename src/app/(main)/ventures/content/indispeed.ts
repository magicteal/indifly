...
const content: VentureContent = {
  ...
  hero: {
    ...
    description:
      "IndiSpeed is a logistics orchestration platform built for Bharat. Designed for D2C brands, SMEs, and enterprises, it integrates seamlessly with ONDC and helps businesses ship faster, smarter, and at scale.",
  },
  cards: [
    {
