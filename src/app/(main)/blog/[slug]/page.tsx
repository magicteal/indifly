      ...
      <Container className="mt-20 md:mt-24">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <article className="lg:col-span-2">
            ...
            <h1 className="mt-6 text-3xl font-bold text-[#1B1B1F]">
              {post.title}
            </h1>
              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center gap-2">
                    <Image
                      src={post.author?.avatar || "/home/blog.png"}
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center justify-center rounded-full bg-white/20 p-2"
                    >
