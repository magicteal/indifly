  ...
  return (
    <div className={cn("flex items-stretch gap-4", className)}>
      ...
      <span
        aria-hidden
        className={cn(
          "w-[4px] self-stretch rounded-full",
      ...
      <div className="min-w-0">
        {label ? (
          <div
            className={cn("text-sm text-white/95 md:text-base", labelClassName)}
          >
            {label}
          </div>
        ) : null}
        <h2
          className={cn(
            "mt-1 text-2xl leading-tight font-bold md:text-4xl lg:text-5xl",
        ...
        {description ? (
          <p
            className={cn(
              "mt-3 text-base text-white/80 md:text-lg",
              descriptionClassName,
            )}
          >
            {description}
