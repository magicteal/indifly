  ...
  return {
    ...
    Stepper: {
      Provider: ({
        ...
        const { initialStep, initialMetadata, ...restProps } = props;
        return (
...
const classForSeparator = cva(
  [
    "bg-muted",
    "data-[disabled]:opacity-50 data-[state=completed]:bg-primary",
...
// NOTE: Using a namespace here to group exported types alongside the factory function.
// ESLint rule prefers ES modules, but changing this to separate type exports would ripple through usage.
// Keeping namespace for now per requirement "Don't make any other changes to stepper like UI change".
